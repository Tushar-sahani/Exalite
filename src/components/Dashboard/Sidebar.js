    ...
    <div className={closeMenu === false ? "sidebar" : "sidebar active"}>
      ...
      >
        <ul>
          ...
          <Link to="/myShipment" className="link">
            <li className={location.pathname === "/myShipment" ? "active" : ""}>
              <i class="bi bi-file-earmark-text"></i>
              <span>My Shipment</span>
            </li>
          </Link>
          <Link to="/newShipment" className="link">
            <li
              className={location.pathname === "/newShipment" ? "active" : ""}
            >
              <i class="bi bi-truck"></i>
              <span>New Shipment</span>
            </li>
          </Link>
          <Link to="/deviceData" className="link">
            <li className={location.pathname === "/deviceData" ? "active" : ""}>
              <i class="bi bi-hdd"></i>
